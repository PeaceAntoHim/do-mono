...
if [ ! -d "/etc/letsencrypt/live/backoffice-stg.dariordal.com" ]; then
...
DOCKER_COMPOSE_CMD="docker compose -f docker-compose.stg.yml"
...
COMPOSE_BAKE=true $DOCKER_COMPOSE_CMD up -d --build

echo "Docker setup complete!"
echo "You can access your application at: https://.store (or http://localhost dariordal.comal dev)"
